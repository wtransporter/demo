        ...
        <div class="px-5 grid grid-cols-1 md:grid-cols-10 container mx-auto max-w-7xl text-gray-400">
            <div class="pt-20 px-4 text-sm md:col-span-4">
                ...
                <ul class="flex text-white" style="font-size: 18px">
                    ...
                    <li class="mr-4">
                        <a class="flex items-center align-middle bg-gray-800 w-10 h-10 rounded-full hover:cursor-pointer" href="#">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 19" class="w-4 text-white mx-auto">
                                <g fill-rule="nonzero" class="fill-current">
            ...
            <div class="grid grid-cols-2 md:col-span-6">
                <div class="md:ml-24 pt-20 px-4">
